...
$this->registerCssFile('/style/jqzoom.css');
//$this->registerJsFile('/js/goods.js');
//$this->registerJsFile('/js/jqzoom-core.js');
$js = <<<ETO
$(function(){
			$('.jqzoom').jqzoom({
	            zoomType: 'standard',
...
<div class="main w1210 mt10 bc">
    ...
    <div class="goods_content fl mt10 ml10">
        <!-- 商品概要信息 start -->
        <div class="summary">
            <h3><strong><?=$rows->name?></strong></h3>

            <!-- 图片预览区域 start -->
            <div class="preview fl">
                <div class="midpic">
                    <a href="<?=Yii::$app->params['adminUrl'].$rows->logo?>" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
                        <?=Html::img(Yii::$app->params['adminUrl'].$rows->logo,['width'=>'300px;'])?>               <!-- 第一幅图片的中图 -->
                    </a>
                </div>
                <!--<div id="content" style="margin-right:auto;margin-left:auto;width:600px;">
                    <a href='<?/*=Html::img(Yii::$app->params['adminUrl'].$rows->logo)*/?>' class="jqzoom" style="" title="图片标题"> <?/*=Html::img(Yii::$app->params['adminUrl'].$rows->logo,['width'=>'300px'])*/?> </a>
                </div>-->
                ...
                <div class="smallpic">
                    ...
                    <div class="smallpic_wrap">
                        <ul>
                            <li class="cur">
                                <a class="zoomThumbActive" href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: 'images/preview_m1.jpg',largeimage: 'images/preview_l1.jpg'}"><?=Html::img(Yii::$app->params['adminUrl'].$rows->logo)?></a>
                            </li>
                            <li>
                                <a href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: 'images/preview_m2.jpg',largeimage: 'images/preview_l2.jpg'}"><?=Html::img(Yii::$app->params['adminUrl'].$rows->logo)?></a>
                            </li>
                            <li>
                                <a href="javascript:void(0);"
                                   rel="{gallery: 'gal1', smallimage: 'images/preview_m3.jpg',largeimage: 'images/preview_l3.jpg'}">
                                    <?=Html::img(Yii::$app->params['adminUrl'].$rows->logo)?></a>
                            </li>
                            <li>
                                <a href="javascript:void(0);"
            ...
            <div class="goodsinfo fl ml10">
                <ul>
                    <li><span>商品编号： </span><?=$rows->sn?></li>
                    <li class="market_price"><span>定价：</span><em><?=$rows->market_price?></em></li>
                    <li class="shop_price"><span>本店价：</span> <strong><?=$rows->shop_price?></strong> <a href="">(降价通知)</a></li>
                    <li><span>上架时间：</span><?=date('Y-m-d h:i:s',$rows->inputtime)?></li>
                    <li class="star"><span>商品评分：</span> <strong></strong><a href="">(已有21人评价)</a></li> <!-- 此处的星级切换css即可 默认为5星 star4 表示4星 star3 表示3星 star2表示2星 star1表示1星 -->
                </ul>
                <form action="<?=\yii\helpers\Url::to(['cart/notice'])?>" method="get" class="choose">
                    <ul>
        ...
        <div class="detail">
            ...
            <div class="detail_bd">
                ...
                <div class="introduce detail_div none">
                    <div class="attr mt15">
                        <ul>
                            <li><span>商品名称：</span><?=$rows->name?></li>
                            <li><span>商品编号：</span><?=$rows->sn?></li>
                            <li><span>品牌：</span><?=$rows->goodsBrand->name?></li>
                            <li><span>上架时间：</span><?=date('Y-m-d h:i:s',$rows->inputtime)?></li>
                        </ul>
                    </div>
                    ...
                    <div class="desc mt10">
                        ...
                        <?=Html::img(Yii::$app->params['adminUrl'].$rows->logo)?>
