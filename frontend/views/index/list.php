...
<div style="clear:both;"></div>
        ...
        <?=\frontend\widgets\CateGoryWidgets::widget(['cate_id'=>$id])?>
        <!-- 新品推荐 start -->
        ...
        <div class="goodslist mt10">
            <ul>
                <?php foreach($rows as $row):?>
                    <li>
                        <dl>
                            <dt><a href="<?=\yii\helpers\Url::to('goods?id='.$row->id)?>"><?=\yii\helpers\Html::img(Yii::$app->params['adminUrl'].$row->logo)?></a></dt>
                            <dd><a href="<?=\yii\helpers\Url::to('goods?id='.$row->id)?>"><?=$row->name?></a></dt>
